...
@deftech{@seclink[#:doc srfi "srfi-17"]{SRFI 17}}, resembling the
original proposal by @citet[lisp-mac] to an extent.  That is, a
@tech{getter procedure} can be associated with a
